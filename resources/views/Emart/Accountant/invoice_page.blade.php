    ...
    <div class="main-container">
        <div class="xs-pd-20-10 pd-ltr-20">
            <div class="title pb-20">
                <h2 class="h3 mb-0">{{ __('words.invoicecreate') }}</h2>
            </div>
                ...
                <div class="container-fluid">
                  ...
                  <div class="my-3 d-flex justify-content-end">
                    <button type="button" class="btn btn-primary" data-toggle="modal" data-target="#exampleModal">
                        <i class="icon-copy bi bi-journal-plus"></i> {{ __('words.newbranch') }}
                    </button>
                    <a class="btn btn-success mx-2" href="{{ route('branches.page') }}">{{ __('words.branches') }}</a>
                  </div>
                        ...
                        <div class="modal-dialog modal-dialog-centered" role="document">
                            <div class="modal-content">
                                <div class="modal-header">
                                    <h5 class="modal-title" id="exampleModalLabel">{{ __('words.newbranch') }}</h5>
                                ...
                                <form action="{{ route('add.branch') }}" method="post">
                                    ...
                                    <div class="modal-footer">
                                        ...
                                        <button type="submit" class="btn btn-primary"
                                            type="submit">{{ __('words.add') }}</button>
                                    </div>
                                </form>
                            </div>
                        </div>
                    ...
                    <div class="row">
                        ...
                        <div class=" col-12 mb-30">
                            <div class="pd-20 card-box">
                                <h5 class="h4 text-blue mb-20">{{ __('words.invoicecreate') }}</h5>
                                <div class="tab">
