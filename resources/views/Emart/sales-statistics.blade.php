...
<body>
    ...
    <div class="main-container">
        <div class="xs-pd-20-10 pd-ltr-20">
            <div class="title pb-20">
                <h2 class="h3 mb-0">{{ __('words.salesstatics') }}</h2>
            </div>
            <div class="container-fluid py-4">
                <a href="{{ route('emart.statistics') }}"class="btn btn-primary my-4">{{ __('words.statistics') }}</a>
    ...
    <script type="text/javascript">
        ...
        const data = {
            labels: labels,
            datasets: [{
                label: 'عدد الفواتير / لفرد المبيعات',
